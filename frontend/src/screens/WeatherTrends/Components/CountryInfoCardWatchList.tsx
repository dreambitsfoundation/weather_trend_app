...
const CountryInfoCardWatchList = (props: SavedLocations) => {
  ...
  const handleCountrySelection = () => {
    props.selectionHandler(props.country.hash, props.country.address);
  ...
  return (
    <Flex
      style={{
        ...
        padding: "10px",
        cursor: "pointer",
        color: currentSelectionState ? "white" : "black",
        backgroundColor: currentSelectionState ? "green" : "white",
      }}
      onClick={(event) => handleCountrySelection()}
    >
